...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/kadir/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20a8d486eaa0326b2c5b37VBZdBBYFXwRVVgNWU1UGUVdTVgBW', mode: 'build'}); } catch(cjsError) { try { import('file:///home/kadir/.vscode/extensions/wallabyjs.console-ninja-1.0.360/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20a8d486eaa0326b2c5b37VBZdBBYFXwRVVgNWU1UGUVdTVgBW', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
